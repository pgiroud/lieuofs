...
import ch.ge.afc.ofs.TypeMutation;
import ch.ge.afc.ofs.canton.CantonCritere;
...
import ch.ge.afc.ofs.commune.biz.dao.CommuneOFSDao;
import ch.ge.afc.ofs.commune.biz.dao.PersistCommune;
import ch.ge.afc.ofs.district.IDistrict;
import ch.ge.afc.ofs.district.biz.IGestionDistrict;

import static ch.ge.afc.ofs.TypeMutation.CHGT_NOM_COMM;
import static ch.ge.afc.ofs.TypeMutation.CHGT_NOM_DIST;
import static ch.ge.afc.ofs.TypeMutation.MODIF_TERR;
import static ch.ge.afc.ofs.TypeMutation.RATT;
import static ch.ge.afc.ofs.TypeMutation.RENUMEROTATION_FORMELLE;
import static ch.ge.afc.ofs.district.TypeDistrict.DISTRICT;
...
public class GestionCommune implements IGestionCommune {
	...
	/* (non-Javadoc)
	 * @see ch.ge.afc.ofs.commune.biz.IGestionCommune#rechercherMutation(ch.ge.afc.ofs.commune.MutationCommuneCritere)
	 */
	@Override
