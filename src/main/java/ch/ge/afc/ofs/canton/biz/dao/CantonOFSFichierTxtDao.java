 ...
 */
package ch.ge.afc.ofs.canton.biz.dao;
...
import ch.ge.afc.ofs.canton.biz.Canton;
...
public class CantonOFSFichierTxtDao extends FichierOFSTxtDao implements CantonOFSDao {
	...
	/* (non-Javadoc)
	 * @see ch.ge.afc.ofs.canton.biz.dao.CantonOFSDao#lire(java.lang.Long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ch.ge.afc.ofs.canton.biz.dao.CantonOFSDao#rechercher(ch.ge.afc.ofs.canton.CantonCritere)
	 */
	@Override
